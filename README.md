...
-[**Installing and Configuring Wireless LAN Access and Security**](https://github.com/AnthonyAAlston/Wireless-Network)  
  Configured and secured a wireless LAN in Cisco Packet Tracer using a Linksys WRT300N. Implemented WAN/LAN addressing, enabled DHCP, applied WPA2-Personal security, disabled SSID broadcast, manually connected a wireless client, and verified end-to-end connectivity.
